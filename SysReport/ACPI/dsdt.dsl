 ...
 *
 * Disassembly of dsdt.dat, Fri Aug 20 20:40:52 2021
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0002362C (144940)
 *     Revision         0x02
 *     Checksum         0x81
 *     OEM ID           "HPQOEM"
 *     OEM Table ID     "17A7    "
 ...
 */
DefinitionBlock ("", "DSDT", 2, "HPQOEM", "17A7    ", 0x00000001)
{
    /*
    ...
    OperationRegion (AF10, SystemMemory, 0xB9F6D018, 0x0DB7)
    ...
    Scope (\_TZ)
    {
        ...
        Method (WQBI, 1, Serialized)
        {
            ...
            Switch (Arg0)
            {
                ...
                Case (0x01)
                {
                    Local0 = \_TZ.CPUZ._TMP ()
                    Local1 = \_TZ.CPUZ._HOT ()
                    If ((Local0 >= Local1))
                    {
                        DerefOf (SEN1 [Arg0]) [0x04] = 0x03
                ...
                Case (0x02)
                {
                    Local0 = \_TZ.GFXZ._TMP ()
                    Local1 = \_TZ.GFXZ._PSV ()
                    If ((Local0 >= Local1))
                    {
                        DerefOf (SEN1 [Arg0]) [0x04] = 0x03
                        DerefOf (SEN1 [Arg0]) [0x05] = "Caution"
                ...
                Case (0x03)
                {
                    Local0 = \_TZ.EXTZ._TMP ()
                }
                Case (0x04)
                {
                    Local0 = \_TZ.LOCZ._TMP ()
                }
                Case (0x05)
                {
                    Local0 = \_TZ.BATZ._TMP ()
                    Local1 = \_TZ.BATZ._PSV ()
                    If ((Local0 >= Local1))
                    {
                        DerefOf (SEN1 [Arg0]) [0x04] = 0x03
                        DerefOf (SEN1 [Arg0]) [0x05] = "Caution"
    ...
    Scope (\_SB)
    {
                ...
                Device (RHUB)
                {
                    ...
                    Device (HSP1)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            CreateBitField (DerefOf (PLDP [0x00]), 0x40, VIS)
                            If (!(PR2 & 0x01))
                            {
                                VIS &= 0x00
                            }
        ...
        Name (BSOL, Package (0x02)
        {
            ...
            {
                "UEFI Boot Order", 
                " Notebook Upgrade Bay, OS Boot Manager, Notebook IPV4 Ethernet, Notebook IPV6 Ethernet, USB Hard Drive, eSata Hard Drive, SD Card Boot, HP Hypervisor, Generic USB Device, Customized Boot, , , , , , ,", 
                "\\System Configuration\\Boot Options", 
                0x00, 
                0x01, 
                0x00, 
        ...
        Name (BISE, Package (0xFE)
        {
            ...
            Package (0x10)
            {
                "Wireless Manageability Control Activate", 
                "", 
                "\\System Configuration\\AMT Options", 
                0x00, 
                0x00, 
        ...
        Device (WMID)
        {
            ...
            Method (FNID, 0, NotSerialized)
            {
                ...
                If ((\SRCM (TEMP, "Notebook IPV4 Ethernet", 0x16) || \SRCM (TEMP, " Notebook IPV4 Ethernet", 0x17)))
                {
                    Local3 = 0x03
                }

                If ((\SRCM (TEMP, "Notebook IPV6 Ethernet", 0x16) || \SRCM (TEMP, " Notebook IPV6 Ethernet", 0x17)))
                {
                    Local3 = 0x04
                }
                ...
                If ((\SRCM (TEMP, "HP Hypervisor", 0x0D) || \SRCM (TEMP, " HP Hypervisor", 0x0E)))
                {
                    Local3 = 0x0B
                }
                ...
                If ((Arg1 == 0x01))
                {
                    ...
                    If ((Local2 == 0x01))
                    {
                        ...
                        ElseIf (\SRCP (DerefOf (Local0 [0x0E]), NONO))
                        {
                            ...
                            ElseIf ((\SRCM (ST01, "Reset BIOS security to factory default", 0x26) == 0x00))
                            {
                                PCHG = 0x01
                            }
                        }
                    ...
                    If ((Local2 == 0x02))
                    {
                        ...
                        {
                            Debug = "HP Hypervisor Config Hash"
                            Local1 = 0x00
                        ...
                        If (\SRCM (ST01, "Turbo Boost support while on battery", 0x24))
                        {
                            ...
                            While ((Local1 != 0x0A))
                            {
                                WETD [Local1] = DerefOf (ST02 [Local1])
                                Local1++
                            }
            ...
            Name (_WDG, Buffer (0x0118)
            {
                ...
                /* 0070 */  0x09, 0xE7, 0x51, 0x33, 0x42, 0x43, 0xFE, 0x00,  // ..Q3BC..
                /* 0078 */  0xE3, 0x08, 0x8D, 0x98, 0xF4, 0x68, 0x35, 0x4C,  // .....h5L
                /* 0080 */  0xAF, 0x3E, 0x6A, 0x1B, 0x81, 0x06, 0xF8, 0x3C,  // .>j....<
                /* 0088 */  0x42, 0x44, 0x33, 0x00, 0x46, 0x97, 0xEA, 0x14,  // BD3.F...
                ...
                /* 00E8 */  0x24, 0xF2, 0x0C, 0x9A, 0x42, 0x49, 0x06, 0x00,  // $...BI..
